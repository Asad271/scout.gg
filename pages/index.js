...
export default function SpeedTest() {
  ...
  return (
    <div className="container">
      <Head>
        <title>Scout.gg - Internet Speed Test for Gamers</title>
        <meta name="description" content="Free internet speed test for gamers. Test your ping, download, and upload speeds optimized for gaming." />
        <meta name="keywords" content="speed test, internet speed test, ping test, gaming speed test" />
